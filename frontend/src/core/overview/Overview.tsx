        ...
        <Col xs={24} sm={8}>
          <Card variant="borderless" className="stat-card">
            <Statistic
              ...
              precision={2}
              styles={{ 
                content: { fontWeight: 'bold', fontSize: '1.5rem' } 
              }}
              prefix="$"
        ...
        <Col xs={24} sm={8}>
          <Card variant="borderless" className="stat-card">
            <Statistic 
              ...
              value={5390.00} precision={2} 
              styles={{ 
                content: { color: '#52c41a', fontWeight: 'bold' } 
              }}
              prefix="$" 
            />
        ...
        <Col xs={24} sm={8}>
          <Card variant="borderless" className="stat-card">
            <Statistic 
              ...
              value={3800.00} precision={2} 
              styles={{ 
                content: { color: '#ff4d4f', fontWeight: 'bold' } 
              }}
              prefix="$" 
            />
